            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-sm-12">
                        <h4 class="text-uppercase admin-page-heading"><i class="fas fa-users"></i> Account Executives  &nbsp;&nbsp;<a class="btn btn-primary d-print-none" onclick="navigateDashboard();"><i class="fas fa-arrow-circle-left"></i>&nbsp;Back</a></h4>                       
                    </div>
                </div>
    ...
    <script>
		...
		function saveUser() {
			...
			var postData = {
				...
				usr_phone: usr_phone,
				action: 'addUserWithRefActivated'
//				action: 'addUser'
			}
			if (usr_pass_confirm === usr_pass) {
				$.post('controllers/userController.php', postData, function (e) {
