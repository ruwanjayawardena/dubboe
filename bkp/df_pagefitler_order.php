...
<html lang="en">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-sm-12">
                        <h4 class="text-uppercase admin-page-heading"><i class="fas fa-plus-square"></i> Ad Category Page Filter Order &nbsp;&nbsp;<a class="btn btn-primary d-print-none" onclick="navigateDashboard();"><i class="fas fa-arrow-circle-left"></i>&nbsp;Back</a></h4>                       
                    </div>
                </div>
                <div class="row">
    ...
    <script>
		function tblFilterGroup(grp_admaincategory, grp_adsubcategory, callback) {
			console.log(grp_admaincategory+"---"+grp_adsubcategory);
			var tbldata = "";
			$.post('controllers/adFilterSettingsController.php', {action: 'tblPageAllFilterGroupsByCategory', grp_admaincategory: grp_admaincategory, grp_adsubcategory: grp_adsubcategory}, function (e) {
				if (e === undefined || e.length === 0 || e === null) {
					tbldata += '<tr>';
					tbldata += '<td colspan="3" class="bg-danger text-center"> -- Filter groups not available -- </td>';
					tbldata += '</tr>';
				...
				$('.btn_groupinfo').click(function () {
					...
					function cmbCategoryFilterByCategory(groupFilterModal, catfl_admaincategory, catfl_adsubcategory, callback) {
						...
						$.post('controllers/adFilterSettingsController.php', {action: 'cmbCategoryFilterByCategory', catfl_admaincategory: catfl_admaincategory, catfl_adsubcategory: catfl_adsubcategory}, function (e) {
							if (e === undefined || e.length === 0 || e === null) {
								...
								$.each(e, function (index, qdt) {
									selectbox += '<option value="' + qdt.mcmb_id + '">' + qdt.mcmb_name + '</option>';
								});
							}
					...
					groupFilterModal.find('#btn_addfilters').click(function (event) {
						var grinf_filter = groupFilterModal.find('.cmbAdcategory').val();
						var postData = {
