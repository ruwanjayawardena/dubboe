...
<html lang="en">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-sm-12">
                        <h4 class="text-uppercase admin-page-heading"><i class="fas fa-file"></i> <span class="usr_name"></span> Members Credit  &nbsp;&nbsp;<a class="btn btn-primary d-print-none" onclick="navigateDashboard();"><i class="fas fa-arrow-circle-left"></i>&nbsp;Back</a></h4>                       
                    </div>
                </div>
				<div class="row">                    
                    <div class="col">
    ...
    <script>
		...
		function tblPointEarnedUser(callback) {
			var tbldata = "";
			$.post('controllers/userController.php', {action: 'tblAllPointsEarnedUsers'}, function (euser) {
