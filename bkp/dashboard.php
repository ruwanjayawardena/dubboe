...
<html lang="en">
    <head>
		...
		<style>
			...
			.bg-dark {
				background: linear-gradient(45deg, #ff2401,#231b1b 100%) !important;
				-webkit-box-shadow: -2px 6px 18px -6px rgba(46,46,46,1)!important;;
				-moz-box-shadow: -2px 6px 18px -6px rgba(46,46,46,1)!important;
				box-shadow: -2px 6px 18px -6px rgba(46,46,46,1)!important;				
			}
			.small, small {
			...
			body {				
				...
				color: #fff7f29e!important;
			}

			.bg-warning {
				background-color: #fd2300!important;
			}
			.logoText {
				...
				<div class="row">
					...
					<div class="col-lg-6 col-12">
						...
						<div class="row justify-content-center">
							...
							<div class="col-lg-3 col-12 hvr-grow">
								<a href="superadmin.php" class="text-decoration-none">
									<div class="card text-white bg-primary">
										<div class="card-header text-center d-none d-sm-block"><i class="fas fa-users fa-4x"></i></div>
										<div class="card-body text-center">
											<h5 class="card-title"><i class="fas fa-users fa-lg"></i> Super Admin</h5>
											<p class="card-text"><small>Manage System Super Admins</small></p>
										</div>                           
									</div>
								</a>
							</div>	
