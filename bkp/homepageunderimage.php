...
<html lang="en">
    ...
    <body>
        <input type="hidden" id="mo_id" value="<?php
        if (isset($_REQUEST['mo_id']) && !empty($_REQUEST['mo_id'])) {
            echo $_REQUEST['mo_id'];
        }
        ?>">
        ...
        <script id="template-download" type="text/x-tmpl">
            ...
            <td>
            <span class="size">{%=file.name%}<br>{%=o.formatFileSize(file.size)%}</span>
            </td>
            <td>
            {% if (file.deleteUrl) { %}
        ...
        <script>
            ...
            $(function () {
                ...
                $('#fileupload').fileupload({
                    ...
                    url: '../asset_imageuploader/homepageunderimage/index.php',
                    autoUpload: true
                });
