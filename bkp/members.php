            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-sm-12">
                        <h4 class="text-uppercase admin-page-heading"><i class="fas fa-users"></i>  Members  &nbsp;&nbsp;<a class="btn btn-primary d-print-none" onclick="navigateDashboard();"><i class="fas fa-arrow-circle-left"></i>&nbsp;Back</a></h4>                       
                    </div>
                </div>
			...
			$.post('controllers/userController.php', {action: 'userTableByCatID', usr_cat_id: usr_cat_id}, function (e) {
				if (e === undefined || e.length === 0 || e === null) {
					...
					$.each(e, function (index, qdt) {
						...
						if (parseInt(qdt.usr_membership_status) != 1) {
							tbldata += '<button class="btn btn-warning btn_upgrade" value="' + qdt.usr_id + '" data-toggle="tooltip" data-placement="top" title="Membership Upgrade"><i class="fas fa-user-check"></i></button>';
				...
				$('.btn_upgrade').click(function () {
					...
					swal({
						...
						text: "Do you want to upgrade this user membership temporary for a month ?",
						type: "info",
						...
						$.post('controllers/userController.php', {action: 'temporyMShipUpgradeForMonth', usr_id: usr_id}, function (e) {
							if (parseInt(e.msgType) == 1) {
								swal("Membership Upgrade!", e.msg, "success");
								clearUser();
							} else {
								swal("Membership Upgrade!", x.msg, "warning");
							}
						}, "json");
					});
				});
