            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-sm-12">
                        <h4 class="text-uppercase admin-page-heading"><i class="fas fa-female"></i> <span class="usr_name"><?php
                            if (isset($_REQUEST['usr_name']) && !empty($_REQUEST['usr_name'])) {
                                echo $_REQUEST['usr_name'];
                            }
							?></span> Profile image upload  &nbsp;&nbsp;<a class="btn btn-primary d-print-none" onclick="window.history.back(-1)"><i class="fas fa-arrow-circle-left"></i>&nbsp;Back</a></h4>                       
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12 col-sm-12">
        ...
        <script>
                                    ...
                                    $(function () {
                                        ...
                                        $('#fileupload').fileupload({
                                            ...
                                            url: '../asset_imageuploader/userprofileimages/index.php?folderID=' + $('#usr_id').val(),
                                            autoUpload: true
                                        });
