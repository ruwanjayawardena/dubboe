<?php include './access_control/session_open.php'; ?> 
<!doctype html>
<html lang="en">
    <head>
		...
		<style>
            ...
            body {
				background-color: #84a2bf !important;
    ...
    <body>
        ...
        <section class="wrapper">
            <div class="container-fluid">
                        ...
                        <script id="template-upload" type="text/x-tmpl">
                            ...
                            {% } %}
								...
								<script id="template-download" type="text/x-tmpl">
									...
									<td class="videotag">									
									{% if (file.url) { %}							
									{% var ext = file.name.substr(file.name.lastIndexOf('.') + 1); console.log(ext); %}
									{% if (ext === "mp4") { %} 
									<video src="{%=file.url%}" autostart="false" controls="controls"></video>									
									{% }else{ %} 
				...
				<?php include './includes/end-block.php';?>
		...
		$(function () {
			...
			$('#fileupload').fileupload({
				...
				url: '../asset_imageuploader/blog/index.php?folderID=' + $('#blg_id').val(),
				autoUpload: true
			});
