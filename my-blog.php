	...
	<body>
						...
						<div class="col-xl-12 col-12">
							<nav aria-label="breadcrumb">
								<ol class="py-1 breadcrumb">
									...
									<li class="breadcrumb-item"><a href="#">My Blog</a></li>
								</ol>
							</nav>
							<h1 class="text-capitalize"><i class="fas fa-blog"></i> My Blog</h1>
						</div>
					</div>
		...
		<script>
			...
			function tblBlog(callback) {
				var tbldata = "";
				$.post('bkp/controllers/blogController.php', {action: 'getAllBlogByLoggedUser'}, function (e) {
					if (e === undefined || e.length === 0 || e === null) {
						tbldata += '<tr>';
						tbldata += '<td colspan="4" class="bg-danger text-white text-center"> -- Blogs not available -- </td>';
						tbldata += '</tr>';
					...
					$('#tblBlog').on('draw.dt', function () {
						...
						$('.btn_delete').click(function () {
							...
							swal({
								...
								$.post('bkp/controllers/blogController.php', {action: 'deleteBlog', blg_id: blg_id}, function (e) {
						...
						$('.btn_uploadimge').click(function () {
							...
							var modelImgUploderStr = '<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">' +
									...
									'<iframe  id="iframe_imageupload" src="bkp/blog_imageupload.php?blg_id=' + blg_id + '" width="100%"></iframe> ' +
			...
			function saveBlog() {
				...
				$.post('bkp/controllers/blogController.php', postdata, function (e) {
					if (parseInt(e.msgType) == 1) {
						swal("Good job!", e.msg, "success");
						clearBlog();
					} else {
