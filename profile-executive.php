					...
					<div class="row justify-content-center">
						<div class="col-xl-12 col-12">
							...
							<div class="row reflinkDiv">
								...
								<div class="col-xl-2 col-lg-2 col-12 dispVerifyINFO" hidden>
										...
										<div class="row mb-3" hidden>
											<div class="col">
												<span hidden>
													...
													<select class="col-12 form-control cmbCountry form-control-chosen" data-placeholder="Choose a Country...">
												...
												<div class="mb-3"> 
													...
													<select class="col-12 form-control cmbState form-control-chosen" data-placeholder="Choose a State...">
														<option value="" disabled selected>Loading...</option>
													</select>
													<div class="valid-feedback">
														<i class="fas fa-lg fa-check-circle"></i> Looks good! 
												...
												<div class="mb-0">
													...
													<select class="col-12 form-control cmbCity form-control-chosen" data-placeholder="Choose a city...">
														<option value="" disabled selected>Loading...</option>
													</select>
													<div class="valid-feedback">
														<i class="fas fa-lg fa-check-circle"></i> Looks good! 
