					...
					<div class="row justify-content-center">
						...
						<div class="col-xl-5 col-12">
							<div class="box-shadow rounded bg-light px-5 py-5 border-1 border-secondary mx-4">
								...
								<p class="text-center">Registration takes less than a minute but gives you full control over your activities.</p>
								<form id="signup-form" class="form-signin pt-auto">
									...
									<div class="mb-2">
										...
										<input type="hidden" id="pwd_score">
										<div class="valid-feedback">
											<i class="fas fa-lg fa-check-circle"></i> Looks good! 
										</div>
										<div class="invalid-feedback">
									...
									<div class="mb-1 pt-2">	
										<button class="btn btn-primary btn-block mt-3 btn-signup"><i class="fas fa-user-alt"></i> Sign up</button>
										<br>
			...
			$(document).ready(function () {
				...
				options.common = {
					...
					onScore: function (options, word, totalScoreCalculated) {
						...
						$('#pwd_score').val(totalScoreCalculated)
...
//						Request Errand
			...
			$(document).ready(function () {
				$('.btn-signup').click(function (e) {
					e.preventDefault();
					var pwd_score = $('#pwd_score').val();
					if (parseFloat(pwd_score) < 25) {
						Swal.fire('Signup Alert!', 'Please enter a strong password.', 'warning')
					} else {
