...
<html lang="en">
    ...
    <body>
        ...
        <script id="template-download" type="text/x-tmpl">
            ...
            <a href="{%=file.url%}" title="{%=file.name%}" download="{%=file.name%}" data-gallery><img class="img-preview" src="{%=file.thumbnailUrl%}"></a>
            {% } %}
            </span>
            </td>           
...
//xhrFields: {withCredentials: true},
					url: 'asset_imageuploader/advsliderimage/index.php?folderID=' + $('#ad_id').val(),
					autoUpload: true
				});
