...
<html lang="en">
	...
	<body>
				...
				<div class="container">					
					<div class="row justify-content-center mb-4">
						<div class="col-xl-12 col-12">
							...
							<h1 class="text-capitalize"><i class="fas fa-lg fa-ad"></i> <span class="ad_title"></span> | <span class="badge badge-secondary">Upload Media</span></h1>
						</div>
					</div>
						...
						<form class="form-ad">
							<div class="row">
								...
								<div class="col-xl-6 col-12 col-12">
									...
									<div class="mb-3 text-center">									
										<button class="btn btn-translucent-success" id="btn-continue"><i class="fas fa-chevron-right"></i> POST Ad</button>
		...
		<script>
			...
			function saveAdvFinalStep() {
				var ad_id = $('#ad_id').val();
				var postdata = {
					action: "saveAdvFinalStep",
					ad_id: ad_id
				}
